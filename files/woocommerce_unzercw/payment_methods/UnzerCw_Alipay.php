...
class UnzerCw_Alipay extends UnzerCw_PaymentMethod
{
	public $machineName = 'alipay';
	public $admin_title = 'Alipay';
	public $title = 'Alipay';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_unzercw_alipay_icon', 
			UnzerCw_Util::getResourcesUrl('icons/alipay.png')
		);
		parent::__construct();
	}
