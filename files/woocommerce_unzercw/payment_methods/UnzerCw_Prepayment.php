...
class UnzerCw_Prepayment extends UnzerCw_PaymentMethod
{
	public $machineName = 'prepayment';
	public $admin_title = 'Prepayment';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_unzercw_prepayment_icon', 
			UnzerCw_Util::getResourcesUrl('icons/prepayment.png')
		);
		parent::__construct();
	}
