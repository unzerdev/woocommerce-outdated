...
class UnzerCw_DirectDebitsSepa extends UnzerCw_PaymentMethod
{
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_unzercw_directdebitssepa_icon', 
			UnzerCw_Util::getResourcesUrl('icons/directdebitssepa.png')
		);
		parent::__construct();
	}
