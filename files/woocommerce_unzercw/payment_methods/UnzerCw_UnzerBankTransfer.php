...
class UnzerCw_UnzerBankTransfer extends UnzerCw_PaymentMethod
{
	public $machineName = 'unzerbanktransfer';
	public $admin_title = 'Unzer Bank Transfer';
	public $title = 'Unzer Bank Transfer';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_unzercw_unzerbanktransfer_icon', 
			UnzerCw_Util::getResourcesUrl('icons/unzerbanktransfer.png')
		);
		parent::__construct();
	}
