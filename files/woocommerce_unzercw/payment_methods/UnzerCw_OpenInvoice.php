...
class UnzerCw_OpenInvoice extends UnzerCw_PaymentMethod
{
	public $machineName = 'openinvoice';
	public $admin_title = 'Invoice';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_unzercw_openinvoice_icon', 
			UnzerCw_Util::getResourcesUrl('icons/openinvoice.png')
		);
		parent::__construct();
	}
