...
class UnzerCw_SecureSepa extends UnzerCw_PaymentMethod
{
	public $machineName = 'securesepa';
	public $admin_title = 'Secure SEPA';
	public $title = 'Secure SEPA';
	
	protected function getMethodSettings(){
		return array(
			'merchant_name' => array(
				'title' => __("Merchant name", 'woocommerce_unzercw'),
 				'default' => '',
 				'description' => __("Here you can configure the merchant name which is displayed as part of the mandate text.", 'woocommerce_unzercw'),
 				'cwType' => 'textfield',
 				'type' => 'text',
 			),
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_unzercw_securesepa_icon', 
			UnzerCw_Util::getResourcesUrl('icons/securesepa.png')
		);
		parent::__construct();
	}
