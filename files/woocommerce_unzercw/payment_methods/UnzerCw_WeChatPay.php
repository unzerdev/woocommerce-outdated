...
class UnzerCw_WeChatPay extends UnzerCw_PaymentMethod
{
	public $machineName = 'wechatpay';
	public $admin_title = 'WeChat Pay';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_unzercw_wechatpay_icon', 
			UnzerCw_Util::getResourcesUrl('icons/wechatpay.png')
		);
		parent::__construct();
	}
